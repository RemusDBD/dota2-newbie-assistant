...
$outputFile = Join-Path $resolvedOutput 'ChatGPT-Dota2-Newbie-Assistant-v0.9.1.md'
$archiveFile = Join-Path $resolvedOutput 'ChatGPT-Dota2-Newbie-Assistant-v0.9.1.zip'
...
$sourceFiles = @(
    ...
    'references/fundamentals-operations.md',
